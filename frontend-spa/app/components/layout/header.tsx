...
function SearchBar() {
    ...
    return (
        <form 
            ...
            className="mx-auto flex w-full max-w-none items-center gap-2 lg:max-w-3xl 2xl:max-w-4xl"
        >
...
export function Header() {
    return (
        <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-backdrop-filter:bg-background/60">
            ...
            */}
            <div className="flex h-14 w-full items-center md:grid md:grid-cols-[88px_minmax(0,1fr)] lg:grid-cols-[280px_minmax(0,1fr)] px-5 md:px-0">
                
                {/* Левая часть (над сайдбаром) */}
                <div className="flex items-center justify-center gap-4 shrink-0 lg:justify-start lg:px-6">
                    <MobileNav />
                    <Link to="/" className="flex items-center outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2">
                        <BrandLogo />
                    </Link>
                </div>
