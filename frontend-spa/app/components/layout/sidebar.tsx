            ...
            <div className="mx-0 mb-4 mt-auto shrink-0 lg:mx-2">
                {isLoading ? (
                    ...
                    <div className="hidden flex-col gap-3 rounded-2xl border bg-muted/50 p-4 lg:flex">
                        ...
                        <Button onClick={() => navigate("/auth")} className="w-full rounded-full font-bold active:scale-95 transition-transform">Войти</Button>
                        <Button onClick={() => navigate("/auth")} variant="outline" className="w-full rounded-full font-bold active:scale-95 transition-transform">Регистрация</Button>
                    </div>
                )}
            </div>
        </div>
