  ...
  return (
    <html lang="ru" className="light">
      <head>
        ...
        <title>ТОЛК</title>
        <meta name="description" content="Социальная платформа для постов, ответов и обсуждений." />
        <Meta />
        <Links />
      </head>
      <body className="min-h-screen bg-background font-sans antialiased">
        <QueryProvider>
          <div className="relative flex min-h-screen flex-col">
            <Header />
            <div className="min-h-[calc(100vh-3.5rem)] w-full flex-1 md:grid md:grid-cols-[88px_minmax(0,1fr)] lg:grid-cols-[280px_minmax(0,1fr)]">
              <aside className="fixed top-14 z-30 hidden h-[calc(100vh-3.5rem)] w-full shrink-0 border-r md:sticky md:block">
                <Sidebar />
              </aside>
              <main className="flex min-h-[calc(100vh-3.5rem)] w-full flex-col overflow-hidden">
                <div className="flex-1 px-3 py-4 sm:px-4 sm:py-6 md:px-6 lg:px-8">
